...
- If they prefer a more traditional, but still basic [CMS](https://en.wikipedia.org/wiki/Content_management_system), you can add something like [Decap CMS](https://decapcms.org/) to your site, which lets them edit the `.md` files with a [WYSIWYG](https://en.wikipedia.org/wiki/WYSIWYG) editor. To enable your users to login though, you need to host your static website on [Netlify](https://www.netlify.com/) – a sort of GitHub Pages replacement with many more features.
