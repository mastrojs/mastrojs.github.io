...
Feel free to play around with the CSS. Once you're happy with the result (or tired of playing around with the design), click the **Generate** button above the preview. Then don't forget to [save your changes in the _Source Control_ tab](/guide/publish-website/#save-changes-and-publish-to-the-web).
