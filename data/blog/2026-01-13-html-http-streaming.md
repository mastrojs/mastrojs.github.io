...
Feel free to check out and play around with the [whole example project](https://github.com/mastrojs/mastro/tree/main/examples/postgresql). Finally, to stream JSON data as server-sent events, see [HTTP Streaming in the guide](/guide/caching-service-workers-streaming/#http-streaming).
